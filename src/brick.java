...
public class brick {
    int bricksXPos[] = {50,350,450,550,50,300,350,450,550,150,150,450,550,
                        ...
                        700,700,700,700,650,650,700,700,750,750,800,850,850,
                        800,850,900,950,1000,900,900,850,900,950,950,1050,1050,1000,1050,1050,1100,1100,1150};
    ...
    int bricksYPos[] = {50,50,50,50,100,100,100,100,100,150,200,200,200,250,
                        ...
                        150,100,50,350,400,500,550,100,300,300,300,450,650,
                        650,650,600,550,450,400,350,0,0,50,600,550,150,200,250,250,300,600};
    ...
    int solidBricksXPos[] = {150,350,150,500,450,300,600,400,350,200,0,200,
            ...
            1000,1050,1000,1000,1000,950,1000,1050,1050,1100,1100,1150,650,650,500};

    int solidBricksYPos[] = {0,0,50,100,150,200,200,250,300,350,400,400,450,
            550,600,550,500,650,650,650,600,250,300,350,550,100,0,50,100,250,200,500,500,500,600,650,100,150,
            50,600,650,650,400,400,350,350,600,650,200,150,500};

    int brickON[] = new int[84];
